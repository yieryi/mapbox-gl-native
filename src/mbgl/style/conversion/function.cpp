...
template optional<PropertyExpression<std::vector<TextPlacementModeType>>>
    convertFunctionToExpression<std::vector<TextPlacementModeType>>(const Convertible&, Error&, bool);
