...
template optional<PropertyValue<std::vector<TextPlacementModeType>>> Converter<PropertyValue<std::vector<TextPlacementModeType>>>::operator()(conversion::Convertible const&, conversion::Error&, bool, bool) const;
