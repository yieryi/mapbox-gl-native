...
/**
 ...
 @param animated Specify `YES` if you want the map view to animate the change to
    ...
    immediately.
 */
- (void)setContentInsets:(NSEdgeInsets)contentInsets animated:(BOOL)animated __attribute__((deprecated("Use `-setContentInsets:animated:completionHandler:` instead.", "setContentInsets:animated:completionHandler:")));
