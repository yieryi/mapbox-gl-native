...
class LatLngBoundsActivity : AppCompatActivity() {
  ...
  private fun initMapView(savedInstanceState: Bundle?) {
    ...
    mapView.getMapAsync { map ->
      mapboxMap = map
      bounds = createBounds()
      map.cameraPosition = map.getCameraForLatLngBounds(bounds, createPadding(peekHeight))!!
  ...
  private fun loadStyle() {
    mapboxMap.setStyle(Style.Builder()
      ...
      .withSource(GeoJsonSource("symbol", URI("asset://points-sf.geojson")))
  ...
  private fun initBottomSheet() {
    ...
    bottomSheetBehavior.setBottomSheetCallback(object : BottomSheetBehavior.BottomSheetCallback() {
      override fun onSlide(bottomSheet: View, slideOffset: Float) {
        ...
        mapboxMap.cameraPosition = mapboxMap.getCameraForLatLngBounds(bounds, createPadding(bottomPadding))!!
      }
  ...
  private fun createBounds(): LatLngBounds {
